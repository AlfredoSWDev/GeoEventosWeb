package com.alfredo.geoeventosweb.ui.theme
...
// Typography usando las fuentes del sistema (sin Google Fonts — no disponible en WASM).
// Las fuentes Ubuntu / Montserrat del Theme Builder original requieren GMS,
// que no existe en browser. Usamos la escala tipográfica de M3 con pesos correctos.
